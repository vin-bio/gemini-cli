...
# --- 3. Generate Figures ---
def generate_figures(results, pca, df, y_test):
    ...
    fig1.savefig('figure1_data_overview.png', dpi=300)
    plt.close(fig1)
    ...
    fig2.savefig('figure2_classical_models.png', dpi=300)
    plt.close(fig2)
    ...
    fig3.savefig('figure3_boosting_models.png', dpi=300)
    plt.close(fig3)
    ...
    fig4.savefig('figure4_comparison.png', dpi=300)
    plt.close(fig4)
...
if __name__ == '__main__':
    ...
    generate_figures(results, pca, df, y_test)
