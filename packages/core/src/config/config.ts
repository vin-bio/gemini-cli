...
export class Config {
  ...
  private readonly memoryDiscoveryBfsLimit: number;
  ...
  constructor(params: ConfigParameters) {
    ...
    this.memoryDiscoveryBfsLimit = params.memoryDiscoveryBfsLimit ?? 200;
  ...
  getMemoryDiscoveryBfsLimit(): number {
    return this.memoryDiscoveryBfsLimit;
  }
  ...
  async refreshMemory(): Promise<{ memoryContent: string; fileCount: number }> {
    const { memoryContent, fileCount } = await loadServerHierarchicalMemory(
      ...
      this.getMemoryDiscoveryBfsLimit(),
